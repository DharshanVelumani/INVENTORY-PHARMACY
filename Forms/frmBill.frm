...
rs.Open "Select * from Master where DrugID = '" & Replace(Me.cmbpid, "'", "''") & "'", con, adOpenKeyset, adLockOptimistic
...
With rs
    ...
    .Fields("UnitPrice") = Me.txtuprice
    .Fields("TotalPrice") = Me.txtprice
